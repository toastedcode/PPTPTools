...
<<<HEREDOC
      ...
      <div class="flex-vertical content">
         ...
         <div class="heading">Enter Your Work Time</div>

         <div class="description">Record your work time for your assigned job.<br/><br/>  Setup time will not be counted towards paid time unless approved by a supervisor.</div>
...
HEREDOC;
   ...
   private static function timeInput()
   {
      ...
      $html =
<<<HEREDOC
     <div class="flex-vertical" style="align-items:center; margin-bottom: 20px;">

      <!-- Run Time -->
      <div class="flex-vertical time-input-container">
         <div class="form-section-header">Run Time</div>
         <div class="flex-horizontal">
            <!-- Hours input -->
            <div id="run-time-hours-div" class="flex-vertical">
               <div class="form-label">Hours</div>
               <div class="flex-horizontal">
                  <button type="button" class="adjust-time-button" onclick="changeRunTimeHour(-1)">
            ...
            <div class="flex-vertical">
               ...
               <div class="flex-horizontal">
                  <button type="button" class="adjust-time-button" onclick="changeRunTimeMinute(-15)">
                     <i class="material-icons">remove</i>
                  </button>
      ...
      <!-- Setup Time -->
      <div id="setup-time-div" class="flex-vertical time-input-container">
         <div class="form-section-header">Setup Time</div>
         <div class="flex-horizontal">
            <!-- Hours input -->
            <div id="setup-time-hours-div" class="flex-vertical">
               <div class="form-label">Hours</div>
               <div class="flex-horizontal">
                  <button type="button" class="adjust-time-button" onclick="changeSetupTimeHour(-1); updateApproval();">
                     <i class="material-icons">remove</i>
                  </button>
            ...
            <div class="flex-vertical">
               <div class="form-label">Minutes</div>
               <div class="flex-horizontal">
                  <button type="button" class="adjust-time-button" onclick="changeSetupTimeMinute(-15); updateApproval();">
                     <i class="material-icons">remove</i>
                  </button>
      ...
      <!-- Total Time -->
      <div class="flex-vertical time-input-container">
         <div class="form-section-header">Total Time</div>
         <div class="flex-horizontal">
            <!-- Hours input -->
            <div class="flex-vertical">
               <div class="form-label">Hours</div>
